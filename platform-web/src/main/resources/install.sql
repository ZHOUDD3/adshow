...
CREATE TABLE `ad_player_program` (
  ...
  `task_id` varchar(64) DEFAULT NULL COMMENT '对应发布任务ID',
  ...
  `program_resolution` varchar(36) DEFAULT NULL COMMENT '节目分辨率',
  `program_status` tinyint(4) DEFAULT NULL COMMENT '终端的节目状态 0-未下载 1-正在下载 2-下载完成 3-节目删除',
  `program_scenecount` int(11) DEFAULT NULL COMMENT '节目场景数',
  `program_playtimecount` int(11) DEFAULT NULL COMMENT '节目时长',
  `group_id` int(11) DEFAULT NULL COMMENT '所属机构ID',
  `group_name` varchar(64) DEFAULT NULL COMMENT '所属机构名',
  `expiration_time` datetime DEFAULT NULL COMMENT '过期时间',
  `accept_time` datetime DEFAULT NULL COMMENT '接收时间',
  `finish_time` datetime DEFAULT NULL COMMENT '结束时间',
  `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
  `program_priority` int(11) DEFAULT NULL COMMENT '优先级',
  `program_size` bigint(20) DEFAULT NULL COMMENT '节目大小',
  `downlosize` bigint(20) DEFAULT '0' COMMENT '节目当前下载的大小',
  `program_retime` datetime DEFAULT NULL COMMENT '下载数据回传时间',
  `publish_time` datetime DEFAULT NULL COMMENT '(定时)发布时间',
  `publish_type` varchar(32) DEFAULT NULL COMMENT '发布播放方式',
  `program_exclusive` bit(1) DEFAULT NULL COMMENT '是否独占',
  `server_id` varchar(64) DEFAULT NULL COMMENT '分发服务器ID',
  `server_task_id` varchar(64) DEFAULT NULL COMMENT '分发服务器任务ID',
  `create_user` int(11) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_user` int(11) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
